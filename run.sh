...
python experiment_script.py --dataset rt --approach fed --strategy acc --last_interval 30
python experiment_script.py --dataset rt --approach fed --strategy sli --last_interval 30

python experiment_script.py --dataset rt --approach fed --strategy acc --last_interval 30 --proximal_term 1.0
python experiment_script.py --dataset rt --approach fed --strategy sli --last_interval 30 --proximal_term 1.0

python experiment_script.py --dataset rt --approach cen --strategy acc --last_interval 30
python experiment_script.py --dataset rt --approach cen --strategy sli --last_interval 30
