...
nd = NewDataset('helsinki', '/home/diegocdts/eclipse/eclipse-workspace2/ONE/src/reports/helsinki/helsinki_MovementNs2Report.txt')
nd.export_raw_data()

nd = NewDataset('manhattan', '/home/diegocdts/eclipse/eclipse-workspace2/ONE/src/reports/manhattan/manhattan_MovementNs2Report.txt')
nd.export_raw_data()
